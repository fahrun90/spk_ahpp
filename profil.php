		  	...
		  	<p style="margin-bottom:10px;">
                ...
                <form method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" placeholder="Masukkan Password" class="form-control" id="pw" name="pw" value="" required >
                  </div>
                  
                  <button type="submit" class="btn btn-primary"><span class="fa fa-edit"></span> Ubah</button>
                  <button type="button" onclick="location.href='main.php'" class="btn btn-success"><span class="fa fa-history"></span> Kembali</button>
                </form>
