...
$db= new PDO ("mysql:host=localhost;dbname=15183207005_spk_ahp", "root", "");
	   $no=0;
	  $Query5="select nama_alternatif,hasil_akhir,hasil_akhir*100 from ahp_data_alternatif where id_pengguna = '$_SESSION[id_pengguna]' order by hasil_akhir desc ";
	  $query6="select hasil_akhir*100 from ahp_data_alternatif where id_pengguna ='$_SESSION[id_pengguna]' order by hasil_akhir desc";
...
$no++;
 ...
 echo"<td>".$row['hasil_akhir*100']. " % </td>";
