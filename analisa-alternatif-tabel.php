...
?>
    ...
    <button type="button" onclick="location.href='analisa-alternatif.php'" class="btn btn-primary"><span class="fa fa-clone"></span> Analisis Jurusan terhadap kriteria Selanjutnya</button>
